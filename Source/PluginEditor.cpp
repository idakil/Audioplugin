...
CompressorComponent::CompressorComponent(Compressor& comp)
    ...
    , wetDrySlider(juce::Slider::LinearVertical, juce::Slider::TextBoxBelow)
    ...
    , gainAttachment(*comp.gainParam, gainSlider)
    , wetDryAttachment(*comp.wetDryParam, wetDrySlider)
{
    ...
    compressorFlexBox.items.add(juce::FlexItem(gainSlider).withFlex(1));
    compressorFlexBox.items.add(juce::FlexItem(wetDrySlider).withFlex(1));
...
void CompressorComponent::paint(juce::Graphics& g) {
    ...
    g.drawText("Gain", gainSlider.getX() + gainSlider.getWidth() / 2 - labelW / 2, labelPosition, labelW, 20, juce::Justification::centred);
    g.drawText("Dry/Wet", wetDrySlider.getX() + wetDrySlider.getWidth() / 2 - labelW / 2, labelPosition, labelW, 20, juce::Justification::centred);
...
void CompressorComponent::resized() {
    ...
    int y = 45;
    auto bounds = getLocalBounds();
    threshSlider.setBounds(getWidth() / 7 - w / 3, y, w, getHeight() - sliderHeightMargin);
    slopeSlider.setBounds(2 * getWidth() / 7 - w / 3, y, w, getHeight() - sliderHeightMargin);
    attackSlider.setBounds(3 * getWidth() / 7 - w / 3, y, w, getHeight() - sliderHeightMargin);
    releaseSlider.setBounds(4 * getWidth() / 7 - w / 3, y, w, getHeight() - sliderHeightMargin);
    gainSlider.setBounds(5 * getWidth() / 7 - w / 3, y, w, getHeight() - sliderHeightMargin);
    wetDrySlider.setBounds(6 * getWidth() / 7 - w / 3, y, w, getHeight() - sliderHeightMargin);
...
BitCrusherComponent::BitCrusherComponent(BitCrusher& bitCrusher)
    ...
    , wetDryAttachment(*bitCrusher.wetDryParam, wetDrySlider)

{
    ...
    bitCrusherFlexBox.items.add(juce::FlexItem(wetDrySlider).withFlex(1));
...
void BitCrusherComponent::resized()
{
    ...
    noiseSlider.setBounds(getWidth() / 5 - w / 2, y, w, getHeight() - sliderHeightMargin);
    bitReduxSlider.setBounds(2 * getWidth() / 5 - w / 2, y, w, getHeight() - sliderHeightMargin);
    rateReduxSlider.setBounds(3 * getWidth() / 5 - w / 2, y, w, getHeight() - sliderHeightMargin);
    wetDrySlider.setBounds(4 * getWidth() / 5 - w / 2, y, w, getHeight() - sliderHeightMargin);
...
EqBandComponent::EqBandComponent(Equaliser& eq)
    ...
    , wetDryAttachment(*eq.wetDryParam, wetDrySlider)

{
    ...
    eqFlexBox.items.add(juce::FlexItem(wetDrySlider).withFlex(1));
...
void EqBandComponent::paint(juce::Graphics& g)
{
    ...
    g.drawText("Dry/Wet", wetDrySlider.getX() + wetDrySlider.getWidth() / 2 - labelW / 2, 40, labelW, 20, juce::Justification::centred);
...
void EqBandComponent::resized()
{
    ...
    int y = 50;
    auto bounds = getLocalBounds();
    freqSlider.setBounds(getWidth() / 5 - w / 2, y, w, getHeight() - sliderHeightMargin);
    qualSlider.setBounds(2 * getWidth() / 5 - w / 2, y, w, getHeight() - sliderHeightMargin);
    gainSlider.setBounds(3 * getWidth() / 5 - w / 2, y, w, getHeight() - sliderHeightMargin);
    wetDrySlider.setBounds(4 * getWidth() / 5 - w / 2, y, w, getHeight() - sliderHeightMargin);
